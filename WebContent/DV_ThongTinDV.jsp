            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a href="#" data-toggle="collapse" data-parent="#accordion"><td width="40"><p align="left"><img src="hinhanh/user.png" width="24" height="24"><b>THÔNG TIN CÁ NHÂN</b></p></td></a>
                </h4>
              </div>
            </div>
      </div>
     ...
     <td colspan="3" align="right">
        <table width="100%" border="0" align="right" style="background: #b5b6b5">
          <tbody><tr>
            <td align="right">
              <div align="center">
                <img src="hinhanh/lock.png" width="24" height="24">
              </div>
            </td>
            <td class="title" align="left">
              <a onclick="onClickTab('DV_UpdatePass.jsp');">Đổi mật khẩu</a>
              
            </td>
            <td class="title" align="right">
              <div align="center" class="style2">
                <img src="hinhanh/accept_page.png" width="24" height="24">
              </div>
            </td>
            <td class="title" align="left">
              <a onclick="onClickTab('DV_CapNhatThongTin_Lai.jsp');">Cập nhật</a>
            </td>
            </tr>
          </tbody></table>
      </td>
