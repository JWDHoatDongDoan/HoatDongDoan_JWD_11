...
<div class="container">
  ...
  <div class="panel panel-default">
	...
	<div class="row">
	<div class="col-md-10">
	<div id="main" ng-app="demoApp" ng-controller="RegisterCtrl"> <!--- ng-app="demoApp" tên moduel mà chúng ta đặt để Angular JS quản lý, RegisterCrtl là controller sẽ quản lý application-->	
    <form class="form-horizontal" name="form" ng-submit="register()" novalidate> <!---novalidate sẽ tắt chế độ validate mặc định của trình duyệt, ng-submit="register()" là tên hàm thực thi khi form submit -->
           <!--- <div class="form-group">
        	...
        	<div class="modal-body">
					<label class="radio-inline"><input type="radio" name="optradio"><a href="DV_Home.jsp">Đoàn viên</a></label>
					<label class="radio-inline"><input type="radio" name="optradio"><a href="CBDK_Home.jsp">Cán bộ Đoàn khoa</a></label>
					<label class="radio-inline"><input type="radio" name="optradio"><a href="CBT_Home.jsp">Cán bộ Đoàn trường</a></label>
					<label class="radio-inline"><input type="radio" name="optradio"><a href="Admin_Home.jsp">Admin</a></label>
			</div>
			</div>
			...
			<div ng-show="form.username.$dirty && form.username.$invalid" class="text-danger"><span class="glyphicon glyphicon-ok"></span>
				<i class="fa fa-times text-danger"></i> 
					<span ng-show="form.username.$error.required"> Username isn't empty </span> 
					<span ng-show="form.username.$error.minlength"> Username must be longer than 6 characters </span> 
					<span ng-show="form.username.$error.maxlength"> Username must ne shorter than 30 characters </span> 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-9">
            ...
            <span ng-show="form.password.$error.required">Password isn't empty</span>
            <span ng-show="form.password.$error.minlength">Password must be 6 characters</span>
            <span ng-show="form.password.$error.maxlength">Password must be 13 characters</span>
            </div>
        </div>
    </div>
   	<div class="form-group">
        ...
        <div class="col-xs-9">
            ...
            <div ng-show="form.email.$dirty && form.email.$invalid" class="text-danger"><i class="fa fa-times text-danger"></i>
                <span ng-show="form.email.$error.required">You don't enter your email adrdess</span>
                <span ng-show="form.email.$error.email">Malformed email</span>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-xs-9">
            <button type="submit" class="btn btn-primary" > Login   </a><i class="fa fa-sign-in"></i></button>
